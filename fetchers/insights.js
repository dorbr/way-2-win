...
async function generateMarketInsight(macroData, stockData) {
    ...
    try {
        ...
        if (stockData) {
            ...
            - Recent Trend (5 days): ${JSON.stringify(stockData.history.slice(-5).map(h => h.close))}
            `;
        }
...
module.exports = { generateMarketInsight };
